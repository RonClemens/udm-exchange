...
| PKM Entity Model | v0.4.0 (exploratory) | `pkm/PKM_ENTITY_MODEL.md` |
| SE Workbench Migration Plan | v0.3.1 (draft) | `migration-plans/se-workbench/PKM_MIGRATION_PLAN.md` |
