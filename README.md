...
| PKM Entity Model | v0.2.2 (exploratory) | `pkm/PKM_ENTITY_MODEL.md` |
| SE Workbench Migration Plan | v0.2.1 (draft) | `migration-plans/se-workbench/PKM_MIGRATION_PLAN.md` |
