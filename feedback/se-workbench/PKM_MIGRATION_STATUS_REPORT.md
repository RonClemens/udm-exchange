...
- **Step 11 (`baselineId`/`projectId` on CI/Specification/SafetyDeliverable/ProgramPlanningDeliverable):** checked all four types' real data — **0 null/missing across every record, in this app's current seed data and in the commit that was live on the deployed demo before this ACTION was sent.** This was Migration Plan Step 1/2 work, complete long before this session. No backfill was needed or performed.
